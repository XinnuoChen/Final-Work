...
---
Dataset de 8 variables normals, 500 observacions i amb patrons de dos cluster.
...
specks <- function(data, sample=FALSE, minbucket=5, cp = 1e-3){   #### With pvalue
  ...
  return(data.frame(
    "Specks" = specks.value, 
    "P-value" = p.value,
    "Propensity score real" = prop.score.real,
    "Propensity score synthetic" = prop.score.synt))
}
...
# Metrics
```{r}
save(km.real, km.synt, ls.km.synt, k.real, k.synt, real.data, synt.data, specksa, file = "Objetctv0_2.RData")
load("Objetctv0_2.RData")
...
Gini: mes proper a 0, mides mes igualats -> rati de gini -> s'espera proper a 0. 
